...
export default function Skills() {
  ...
  return (
    <section ref={sectionRef} id="skills" aria-label="Technical Skills" className="relative py-20 px-8 lg:px-16 border-t border-border bg-bg">
      ...
      <div className="relative z-10 max-w-6xl mx-auto">
        <ScrollReveal>
          ...
          <h2 className="font-display font-semibold text-fg text-3xl lg:text-4xl leading-tight mb-14">
            Ask my terminal, not my resume.
          </h2>
        </ScrollReveal>

        <ScrollReveal delay={0.1}>
          <div className="font-mono text-xs text-fg/40 mb-3 text-left">
