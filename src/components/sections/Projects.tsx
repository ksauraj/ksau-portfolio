...
export default function Projects() {
  return (
    <section id="projects" aria-label="Projects" className="py-32 px-8 lg:px-16 border-t border-border bg-bg">
              ...
              >
                ...
                <div className="p-8">
                  <div className="flex flex-wrap gap-2 mb-4">
                    ...
                    <span className="font-mono text-sm text-fg/20 ml-auto self-center select-none">{project.year}</span>
                  </div>
                  <h3 className="font-display font-semibold text-fg text-2xl mb-3">{project.title}</h3>
