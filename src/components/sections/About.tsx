...
export default function About() {
  return (
    <section id="about" aria-label="About" className="py-32 px-8 lg:px-16 border-t border-border bg-bg relative z-10">
      <div className="max-w-6xl mx-auto grid grid-cols-1 lg:grid-cols-10 gap-16 lg:gap-8">
        ...
        <div className="lg:col-span-6 space-y-12">
          <ScrollReveal>
            ...
            <h2 className="font-display font-medium text-fg text-3xl lg:text-4xl leading-snug">
              {aboutContent.bio}
            </h2>
          </ScrollReveal>
        </div>
          ...
          <ScrollReveal delay={0.15}>
            <div className="border border-border bg-surface p-6 flex flex-col justify-between">
              <div>
                ...
                <h3 className="font-display font-bold text-fg text-3xl mt-4">
            ...
            {aboutContent.stats.map((stat, index) => (
              <ScrollReveal key={stat.label} delay={0.2 + index * 0.05}>
                <div className="border border-border bg-card p-6 text-center hover:border-hover transition-all duration-300">
                  <div className="font-display font-bold text-fg text-4xl lg:text-5xl mb-2">
                    <CountUp
                      end={stat.value}
                      suffix={stat.suffix}
