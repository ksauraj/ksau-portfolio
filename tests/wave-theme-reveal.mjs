...
assert.match(css, /animation-duration:\s*1450ms/, 'snapshot reveal matches binary wave duration')
assert.match(pixelTransition, /const DURATION = 1450/, 'canvas wave uses the shared reveal timing')
