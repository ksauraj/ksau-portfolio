...
assert.match(transition, /crestPosition/, 'binary glyphs form an expanding circular ring')
assert.match(transition, /radius - waveWidth[\s\S]*radius/, 'binary crest is selected from the bounded annulus behind the reveal boundary')
